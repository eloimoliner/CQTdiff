import os
import torch
from src.sampler import SamplerCompSens
...
class Exp_CompSens(Exp_Base):
    def __init__(self, args, plot_animation):
        ...
        #clipping specific
        n="masked"+"_"+str(self.args.inference.comp_sens.percentage)
        ...
        n="reconstructed"+"_"+str(self.args.inference.comp_sens.percentage)
